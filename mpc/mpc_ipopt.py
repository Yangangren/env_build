...
class HierarchicalMpc(object):
    def __init__(self, task, logdir):
        ...
        if self.task == 'left':
            ...
            self.policy = LoadPolicy('../utils/models/right/experiment-2021-03-15-21-02-51', 195000)
        elif self.task == 'straight':
            self.policy = LoadPolicy('../utils/models/straight/experiment-2021-03-15-19-16-13', 175000)
