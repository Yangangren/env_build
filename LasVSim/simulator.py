...
class Simulation(object):
    ...
    def __init__(self, canvas=None, setting_path=None, learner_settins=None):
        ...
        self.settings=Settings(file_path=setting_path)

    def reset(self, settings=None, init_traffic=None, start_position=None, density = 'Sparse', simu_method=False):
        ...
        settings.traffic_lib = density


        #print(settings.traffic_lib)
        ...
        if start_position is not None:
            settings.points[0]=start_position
        ...
        #self.agent.sensors.setVehicleModel(vehicle_model)
    ...
    def get_ego_info(self):
        return self.agent.dynamic.get_pos(), self.agent.dynamic.get_info(), self.traffic.get_road_related_info_of_ego()
