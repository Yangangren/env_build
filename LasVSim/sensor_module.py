...
@file_desc: Sensor module for LasVSim-package 0.2.1.191226_alpha
"""
import os
from ctypes import *
...
class Sensors(object):
    ...
    def __init__(self,step_length, sensor_info=None, path=None):
        ...
        other_car_arr = ObjectInfo * self.other_car_num
        detect_car_arr = ObjectInfoFromSensor * self.other_car_num
        self.other_cars = other_car_arr()
        self.detect_cars = detect_car_arr()
        self.veh_route = None
        for i in range(len(self.other_cars)):
