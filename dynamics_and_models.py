...
class ReferencePath(object):
    ...
    def set_path(self, task, green_or_red='green', path_index=None): # todo: depend on map
        ...
        if task == 'left':
            ...
            for start_offset in start_offsets:
                for end_offset in end_offsets:
                    ...
                    control_point4 = end_offset, Para.CROSSROAD_SIZE/2, 90
                    control_point2, control_point3 = get_bezier_middle_point(control_point1, control_point4, task)
                    self.control_points.append([control_point1,control_point2,control_point3,control_point4])
            ...
            assert task == 'right'
            end_offsets = [-Para.LANE_WIDTH * 1.5, -Para.LANE_WIDTH * 0.5]
            ...
            for start_offset in start_offsets:
                for end_offset in end_offsets:
                    ...
                    # control_point2 = start_offset, -CROSSROAD_SIZE/2 + control_ext
                    # control_point3 = CROSSROAD_SIZE/2 - control_ext, end_offset
                    control_point4 = Para.CROSSROAD_SIZE/2, end_offset, 0
                    control_point2, control_point3 = get_bezier_middle_point(control_point1, control_point4, task)
    ...
    def _construct_all_path(self):
        ...
        for start_offset in start_offsets:
            for end_offset in end_offsets:
                ...
                # control_point3 = -CROSSROAD_SIZE/2 + control_ext, end_offset
                control_point4 = -Para.CROSSROAD_SIZE / 2, end_offset, 180
                control_point2, control_point3 = get_bezier_middle_point(control_point1, control_point4, task='left')
                self.control_points.append([control_point1,control_point2,control_point3,control_point4])
        ...
        for start_offset in start_offsets:
            for end_offset in end_offsets:
                ...
                # control_point3 = end_offset, CROSSROAD_SIZE/2 - control_ext
                control_point4 = end_offset, Para.CROSSROAD_SIZE / 2, 90
                control_point2, control_point3 = get_bezier_middle_point(control_point1, control_point4, task='straight')
                self.control_points.append([control_point1,control_point2,control_point3,control_point4])
        ...
        for start_offset in start_offsets:
            for end_offset in end_offsets:
                control_point1 = start_offset, -Para.CROSSROAD_SIZE / 2, 90
                control_point4 = Para.CROSSROAD_SIZE / 2, end_offset, 0
                control_point2, control_point3 = get_bezier_middle_point(control_point1, control_point4, task='right')
                self.control_points.append([control_point1,control_point2,control_point3,control_point4])
    ...
    def _get_point_by_speed(self, xs, ys, phis, vs, dt=0.1, equal_len=False):
        ...
        if equal_len:
            ...
            if len(future_n_x) > self.max_path_len:
                ...
                future_n_phi = future_n_phi[:self.max_path_len]
                future_n_v = future_n_v[:self.max_path_len]
