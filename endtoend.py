        ...
        def filter_interested_other(vs, task):
            ...
            for v in vs:
                ...
                if start == name_setting['do'] and end == name_setting['li']:
                    ...
                    v.update(turn_rad=-1 / (Para.CROSSROAD_SIZE / 2 - 1.5 * Para.LANE_WIDTH))
                    dr.append(v)
            ...
            mode2fillvalue = dict(
                dl=dict(x=1.875, y=-50, v=0, phi=90, w=2.5, l=5, route=('1o', '4i'), turn_rad=0., exist=False),
                du=dict(x=1.875, y=-50, v=0, phi=90, w=2.5, l=5, route=('1o', '3i'), turn_rad=0., exist=False),
                dr=dict(x=5.625, y=-50, v=0, phi=90, w=2.5, l=5, route=('1o', '2i'), turn_rad=0., exist=False),
                ru=dict(x=35, y=5.625, v=0, phi=180, w=2.5, l=5, route=('2o', '3i'), turn_rad=0., exist=False),
                ur=dict(x=-1.875, y=40, v=0, phi=-90, w=2.5, l=5, route=('3o', '2i'), turn_rad=0., exist=False),
                ud=dict(x=-1.875, y=40, v=0, phi=-90, w=2.5, l=5, route=('3o', '1i'), turn_rad=0., exist=False),
                ul=dict(x=-5.625, y=40, v=0, phi=-90, w=2.5, l=5, route=('3o', '4i'), turn_rad=0., exist=False),
                lr=dict(x=-40, y=-1.875, v=0, phi=0, w=2.5, l=5, route=('4o', '2i'), turn_rad=0., exist=False))
